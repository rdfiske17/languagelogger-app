...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    public SuggestionStripView(final Context context, final AttributeSet attrs,
        ...
        final ImageButton privateModeButton = (ImageButton) findViewById(R.id.research_private_mode_button);
        final Drawable activeDrawable = keyboardAttr.getDrawable(R.styleable.Keyboard_iconPrivateModeKeyActive);
        final Drawable inActiveDrawable = keyboardAttr.getDrawable(R.styleable.Keyboard_iconPrivateModeKeyInactive);

        LatinIMEEventController.get().setPrivateModeButton(privateModeButton, activeDrawable, inActiveDrawable);
