...
public class MoreKeysKeyboardView extends KeyboardView implements MoreKeysPanel {
    ...
    public void onDownEvent(final int x, final int y, final int pointerId, final long eventTime) {
        ...
        LatinIMEEventController.get().onTouchDownEvent(eventTime, x, y, -1, -1, mCurrentKey != null ? Constants.printableCode(mCurrentKey.getCode()) : "", true, EventInputMode.DEFAULT);
    }
    ...
    public void onMoveEvent(final int x, final int y, final int pointerId, final long eventTime) {
        ...
        LatinIMEEventController.get().onTouchMoveEvent(eventTime, x, y, -1, -1, mCurrentKey != null ? Constants.printableCode(mCurrentKey.getCode()) : "", true, EventInputMode.DEFAULT);
    }
    ...
    public void onUpEvent(final int x, final int y, final int pointerId, final long eventTime) {
        ...
        LatinIMEEventController.get().onTouchUpEvent(eventTime, x, y, -1, -1, mCurrentKey != null ? Constants.printableCode(mCurrentKey.getCode()) : "", true, EventInputMode.DEFAULT);
    }
