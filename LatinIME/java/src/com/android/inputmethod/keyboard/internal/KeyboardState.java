...
public final class KeyboardState {
    ...
    public void onPressKey(int code, final boolean isSinglePointer, final int autoCapsFlags,
        ...
        } else { // TODO could to another case here for code -10
    ...
    // TODO somewhere is a comment that emoji key is handled here
    public void onEvent(final Event event, final int autoCapsFlags, final int recapitalizeMode) {
        int code = event.isFunctionalKeyEvent() ? event.mKeyCode : event.mCodePoint; // TODO make this final again
        if (code == -10) {
            code = -11; // TODO test
        }
        if (DEBUG_EVENT) {
