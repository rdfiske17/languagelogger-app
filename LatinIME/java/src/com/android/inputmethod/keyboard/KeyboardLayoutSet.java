...
public final class KeyboardLayoutSet {
    ...
    */
    ...
    private Keyboard getKeyboard(final ElementParams elementParams, final KeyboardId id) {
        ...
        /* ResearchIME - disabled keyboard cache to be able to always use the newest layout */
        /*
    ...
    public static final class Builder {
        ...
        private void setLayoutSetName(){
            String layoutSetName = mParams.mSubtype.getKeyboardLayoutSetName();
            mParams.mKeyboardLayoutSetName = KEYBOARD_LAYOUT_SET_RESOURCE_PREFIX + layoutSetName;
        }
