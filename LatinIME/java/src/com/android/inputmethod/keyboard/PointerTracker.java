...
public final class PointerTracker implements PointerTrackerQueue.Element,
    ...
    public EventInputMode getCurrentInputMode(){
        if(sInGesture){
            return EventInputMode.GESTURE;
        }
        if(mIsDetectingGesture){
            return EventInputMode.GESTURE_DETECTING;
        }
        return EventInputMode.DEFAULT;
    }
    ...
    public void processMotionEvent(final MotionEvent me, final KeyDetector keyDetector) {
        ...
        case MotionEvent.ACTION_POINTER_DOWN:
            onDownEvent(x, y, eventTime, keyDetector, me);
            break;
        case MotionEvent.ACTION_UP:
        case MotionEvent.ACTION_POINTER_UP:
            onUpEvent(x, y, eventTime, me);
            break;
    ...
    private void onDownEvent(final int x, final int y, final long eventTime,
            final KeyDetector keyDetector, @Nullable final MotionEvent me) {
        ...
        if (!isShowingMoreKeysPanel()){
            LatinIMEEventController.get().onTouchDownEvent(eventTime, x, y,
                    me != null ? me.getPressure() : -1,
                    me != null ? me.getSize() : -1,
                    key != null ? Constants.printableCode(key.getCode()) : "", false, getCurrentInputMode());
        }
    ...
    private void onMoveEvent(final int x, final int y, final long eventTime, final MotionEvent me) {
        ...
        if (!isShowingMoreKeysPanel()) {
            LatinIMEEventController.get().onTouchMoveEvent(eventTime, x, y,
                    me != null ? me.getPressure() : -1,
                    me != null ? me.getSize() : -1,
                    key != null ? Constants.printableCode(key.getCode()) : "", false, getCurrentInputMode());
        }
    ...
    private void onUpEvent(final int x, final int y, final long eventTime, @Nullable final MotionEvent me) {
        if (DEBUG_EVENT) {
        ...
        if(!isShowingMoreKeysPanel()) {
            LatinIMEEventController.get().onTouchUpEvent(eventTime, x, y,
                    me != null ? me.getPressure() : -1,
                    me != null ? me.getSize() : -1,
                    key != null ? Constants.printableCode(key.getCode()) : "", false, getCurrentInputMode());
        }
