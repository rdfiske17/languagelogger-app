...
public class LogicalWordList extends BaseModel implements LogicalList {
    ...
    public LogicalWordList(int parentRimeContentAbstractionConfigId) {
     ...
     * for DBFlow only!
     */
    public LogicalWordList() {
    }

    public String getLocalFilename(){
        return "wordlist-"+getLogicallistId()+".rime";
    }
